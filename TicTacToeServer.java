...
JButton btn5, JButton btn6, JButton btn7, JButton btn8, JButton
btn9) {
...
public void run() {
	try {
	    ...
	    while (true) { // get x, y coordinates in 2-dimensional array
...
if (TicTacToe.checkWin(board, TicTacToe.NUM_OF_ROWS,
TicTacToe.NUM_OF_COLS,
...
if (TicTacToe.checkTie(++count, TicTacToe.NUM_OF_ROWS,
TicTacToe.NUM_OF_COLS)) {
tieFlag = true;
}
